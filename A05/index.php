...
<body>
  ...
  <header class="bgimg w3-display-container w3-grayscale-min" id="home">
    ...
    <div class="w3-display-middle w3-center">
      <a href="#personalities" class="btn btn-light ms-2 explore">Explore Now</a>
    </div>
    ...
    ?>
        ...
        <div class="w3-container" id="personalities">
          <div class="w3-content" style="max-width:700px">
            ...
            <div class="w3-panel w3-leftbar" style="background-color: <?php echo $personalityRow['color']; ?>; border-radius: 2rem; ">
